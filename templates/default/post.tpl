...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#acc_trigger233').addClass('active').next().show(); //Add "active" class to first trigger, then show/open the immediate next container
...
<div class="shapka">
    ...
    <div align="right" style=" position:absolute; top:20px; right:200px; z-index:20;">
        <p><button type="button" class="btn_pero_mini" onclick="javascript:showPause();">ПАУЗА</button></p>
    </div>
