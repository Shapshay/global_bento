...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#acc_trigger2171').addClass('active').next().show(); //Add "active" class to first trigger, then show/open the immediate next container
...
<div  style="display:none;" id="tmp_name"><template style="display:none;">Автоматическая статистика</template></div>
<script type="text/javascript">
    $("#tmp_name").hide();
    {SCRIPT_MODER1}
