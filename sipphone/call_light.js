    ...
    window.onload = function () {
        ...
        oReadyStateTimer = setInterval(function () {
            if (document.readyState === "complete") {
                ...
                // initialize SIPML5
                preInit();
				oReadyStateBool=true;
				console.log('checkload2');
                //sipRegister();
            }
        },
        100);
    ...
    function loadCallOptions() {
        if (window.localStorage) {
            ...
            bDisableVideo = true; //(window.localStorage.getItem('org.doubango.expert.disable_video') == "true");
    ...
    function loadCredentials() {
        ...
        //else {
        // FIXME
            //txtDisplayName.value = "102";
            //txtPrivateIdentity.value = "102";
            //txtPublicIdentity.value = "sip:102@192.168.0.200";
            //txtPassword.value = "123456";
            //txtRealm.value = "192.168.0.200";
            //txtPhoneNumber.value = "9664";
        //}
    };
    ...
    function sipRegister() {
        ...
        try {
            ...
            oSipStack = new SIPml.Stack({
                    ...
                    //websocket_proxy_url: 'wss://192.168.0.200:7443',//(window.localStorage ? window.localStorage.getItem('org.doubango.expert.websocket_server_url') : null),
                    websocket_proxy_url: 'wss://'+txtFswIP.value+':7443',//(window.localStorage ? window.localStorage.getItem('org.doubango.expert.websocket_server_url') : null),
                    outbound_proxy_url: null, //(window.localStorage ? window.localStorage.getItem('org.doubango.expert.sip_outboundproxy_url') : null),
                    ...
                    bandwidth: null,//(window.localStorage ? tsk_string_to_object(window.localStorage.getItem('org.doubango.expert.bandwidth')) : null), // could be redefined a session-level
                    video_size: null,//(window.localStorage ? tsk_string_to_object(window.localStorage.getItem('org.doubango.expert.video_size')) : null), // could be redefined a session-level
                    sip_headers: [
    ...
    function sipCall(s_phone_number) {
        if (oSipStack && !oSipSessionCall && !tsk_string_is_null_or_empty(s_phone_number)) {
            ...
            // make call
            if (oSipSessionCall.call(s_phone_number) != 0) {
            ...
            case 'i_new_call':
                {
                    if (oSipSessionCall) {
						...
						btnCall.value = btnCall.innerHTML = "Ответить";
