...
<div class="ControlLisenDiv" id="ControlLisenDiv">
    ...
    <form method="post" enctype="multipart/form-data" name="ControlFrm" id="ControlFrm">
        ...
        <div><input type="radio" name="Ocenka" value="1" checked="checked" class="radio" id="radio-1" /><label for="radio-1">Хорошая</label>
            &nbsp;&nbsp;&nbsp;<input type="radio" name="Ocenka" value="0" class="radio" id="radio-2" /><label for="radio-2">Плохая</label></div>
        <div><button type="button" class="btn_pero_mini" onclick="saveControl();">Оценить</button></div>
