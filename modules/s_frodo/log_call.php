...
$result = mysql_query("SELECT COUNT(*) AS count FROM oper_calls WHERE phone2 = ".$_GET['r_id']);
...
while($row = mysql_fetch_array($result,MYSQL_ASSOC)) {
	...
	$responce->rows[$i]['cell']=array($row['id'],$row['call_date'],$row['rating'],$row['phone1'],$row['size'],$audio_link);
	$i++;
} 
