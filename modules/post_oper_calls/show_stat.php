...
if(isset($_POST['oper_id'])){
    ...
    $sql_stat = '';
    if($_POST['stat_id']>0){
        $sql_stat = ' AND res_calls_post.id = '.$_POST['stat_id'];
    }

    $html = '';
    $rows = $dbc->dbselect(array(
        "table"=>"calls_log, oper_calls, users, res_calls_post",
